# LegacyNote Blockchain Stats

LegacyNote Blockchain Stats utlity exports daily statistics for the monero blockchain from creation through current state.

## Usage:

See also the utility's help option. `legacynote-blockchain-stats --help`
...
- `legacynote-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `legacynote-blockchain-stats | save-to-database.sh`
